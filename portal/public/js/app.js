...
Vue.component('user-menu', __webpack_require__(54));
Vue.component('account-setting', __webpack_require__(76));
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_portal_vue__ = __webpack_require__(60);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vue_configuration__ = __webpack_require__(86);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utilities_config__ = __webpack_require__(84);
/**
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__RecoveryModal_vue__ = __webpack_require__(79);
...
(function (global, factory) {
	 true ? module.exports = factory(__webpack_require__(38)) :
	...
	methods: {
		submitForm: function submitForm() {
			...
			this.form.post(this.$config.get('api.url') + 'auth/recovery').then(function (response) {
				return _this.alert = response.data;
			});
		}
	},
	mounted: function mounted() {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Errors_js__ = __webpack_require__(83);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
